...
# Create the plot with facet grid
ggplot(excess_counts, aes(x = agegroup, y = excess_deaths)) +
  geom_bar(stat = "identity", fill = "skyblue") +
  facet_grid(~sex) + # Create separate panels for male and female
  labs(
    title = "Excess Deaths by Age Group and Sex (2017–2018)",
    x = "Age Group",
